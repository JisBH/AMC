...
public class Algoritmos {  
    ...
    public static Solucion DyV(ArrayList<Punto> puntos, int i, int d) {
        ...
        if(opc>3){                                                  
            ...
            dmin.setDist
                (Double.min(di.getDist(), dd.getDist()));   
    ...
    /**
     * Estrategia de búsqueda con técnica Divide y Vencerás con mejora en la búsqueda en la zona intermedia
     */
    ...
    private static Solucion exhaustivo11(ArrayList<Punto> puntos, int izq, int dcha) {
        Solucion sol = new Solucion           
            (puntos.get(izq), puntos.get(dcha));               
        int calculadas = 0;                                                    
        double d;
